  ...
  const contactDetails = [
    {
      ...
      value: "Mr. Ashish Sarin",
      subValue: "Senior Vice President - Customer Success",
    },
    {
      icon: <Mail className="w-6 h-6" />,
      label: "Email Address",
      value: "head.services@dmifinance.in",
      subValue: "grievance@dmifinance.in",
      isEmail: true,
    },
    {
    ...
    },
    {
      ...
      value: "Express Building, 3rd Floor",
      subValue: "9-10, Bahadur Shah Zafar Marg, New Delhi-110002",
    },
  ];
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <div className="flex justify-center mb-6">
            ...
            >
              ...
              {/* <motion.div
                className="absolute -inset-2 bg-gradient-to-r from-red-500 to-red-600 rounded-2xl opacity-20"
                animate={{
                  scale: [1, 1.1, 1],
                }}
                transition={{
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-6">
            Complete grievance redressal information for DMI Finance Private
            Limited. Our dedicated team is committed to resolving your concerns
            promptly and fairly.
          </p>
        </motion.div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700">DMI Finance</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">
                      Legal Name
                    </h3>
                    <p className="text-gray-700">DMI FINANCE PRIVATE LIMITED</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">
                      Website
        ...
        <motion.div {...fadeInUp} className="mb-16">
          ...
          <p className="text-center text-gray-600 mb-8 max-w-3xl mx-auto">
            Designated specifically to deal with FinTech / Digital Lending
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        "mailto:head.services@dmifinance.in",
                        "_blank"
                      )
                    }
                  >
                  ...
                  <Button
                    ...
                    size="lg"
                    className="flex items-center gap-2"
                    onClick={() => window.open("tel:011-41204444", "_blank")}
                  >
